...
/**
 * External task question definition class.
 *
 * @package    qtype
...
/**
 * Represents an external task question.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_externaltask_question extends question_with_responses {
     ...
     * @return qtype_externaltask_format_renderer_base the response-format-specific renderer.
     */
    public function get_format_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_externaltask', 'format_' . $this->responseformat);
    }
    ...
    public function check_file_access($qa, $options, $component, $filearea, $args, $forcedownload) {
        ...
        } else if ($component == 'qtype_externaltask' && $filearea == 'graderinfo') {
