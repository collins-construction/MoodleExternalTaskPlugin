...
/**
 * Unit tests for the externaltask question type.
 *
 * @copyright 2013 The Open University
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_externaltask_walkthrough_testcase extends qbehaviour_walkthrough_test_base {
    ...
    public function test_deferred_feedback_html_editor() {
        ...
        // Create an externaltask question.
    ...
    public function test_deferred_feedback_html_editor_with_files_attempt_on_last() {
        ...
        // Create an externaltask question in the DB.
