...
Feature: In a externaltask question, limit submittable file types
...
I need to limit the submittable file types
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | externaltask       | TF1   | First question  | 20          |
  ...
  Scenario: Preview an External task question and submit a response with a correct filetype.
  ...
  @javascript @_file_upload
  Scenario: Preview an External task question and try to submit a response with an incorrect filetype.
    When I log in as "student1"
    And I follow "Manage private files"
