 ...
 */
class moodle1_qtype_externaltask_handler extends moodle1_qtype_handler {
    ...
    /**
     * Appends the externaltask specific information to the question
     */
    public function process_question(array $data, array $raw) {
        // Data added on the upgrade step 2011031000.
        $this->write_xml('externaltask', array(
